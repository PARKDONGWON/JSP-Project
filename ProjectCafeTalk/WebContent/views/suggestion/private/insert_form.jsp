...
<head>
<meta charset="UTF-8">
<title>views/suggestion/private/insert_form.jsp</title>
<meta charset="utf-8">
...
<body>
	...
	<div class="container-fluid">
		<div class="row content">
			...
			<div class="col-sm-9">
				<h2>공지사항을 입력하세요.</h2>
				<form action="suggestionInsert.do" method="post">
					<label for="writer">작성자</label> 
					<input type="text" id="writer" value="${id }" disabled="disabled" /><br /> 
